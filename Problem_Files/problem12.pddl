...
; their initial state.
;
; Problem file 12 - includes 12 EU countries
(define (problem problem12)
        (:domain EU_economics)
        (:objects Belgium Germany France Italy Luxembourg Netherlands Austria Bulgaria Croatia Cyprus Czech-Republic Denmark  - Country)
...
(:init
       ...
       (is-not-growing-quality-of-life Cyprus)            ; "growing-quality-of-life": false
                                                    ; -- Variables --
       (=(resources-sector Czech-Republic) 150)                  ; "resources": 150
       (=(industry-sector Czech-Republic) 321)                   ; "industry": 321
       (=(services-sector Czech-Republic) 679)                   ; "services": 679
       (=(funds Czech-Republic) 475)                             ; "funds": 475
       (=(quality-of-life-index Czech-Republic) 159)          ; "quality-of-life-index": 159

                                                            ; -- Constants --
       (=(resources-price Czech-Republic) 9)                 ; "resources": 9
       (=(industry-price Czech-Republic) 4)                  ; "industry": 4
       (=(services-price Czech-Republic) 6)                  ; "services": 6
       (=(economy-growth-price Czech-Republic) 12)                       ; "economy growth: " : 12

                                                            ; -- Economy growth --
       (=(resources-growth Czech-Republic) 9)               ; "resources": 9
       (=(industry-growth Czech-Republic) 26)                ; "industry": 26
       (=(services-growth Czech-Republic) 11)                ; "services": s11

                                                            ; -- Quality of life growth --
       (=(quality-index-resources-cost Czech-Republic) 9)     ; "resources": 9
       (=(quality-index-industry-cost Czech-Republic) 19)      ; "industry": 19
       (=(quality-index-services-cost Czech-Republic) 20)      ; "services": 20

       ;predicates initialised                              ; -- Biases --
       (is-not-resources-biased Czech-Republic)             ; resources: false
       (not(is-not-industry-biased Czech-Republic))                   ; industry: true
       (is-not-services-biased Czech-Republic)              ; services: false

                                                            ; -- Technical --
       (is-not-growing-economy Czech-Republic)                    ; "growing-eco": false
       (is-not-growing-quality-of-life Czech-Republic)            ; "growing-quality-of-life": false
                                                    ; -- Variables --
       (=(resources-sector Denmark) 111)                  ; "resources": 111
       (=(industry-sector Denmark) 125)                   ; "industry": 125
       (=(services-sector Denmark) 680)                   ; "services": 680
       (=(funds Denmark) 650)                             ; "funds": 650
       (=(quality-of-life-index Denmark) 199)          ; "quality-of-life-index": 199

                                                            ; -- Constants --
       (=(resources-price Denmark) 20)                 ; "resources": 20
       (=(industry-price Denmark) 20)                  ; "industry": 20
       (=(services-price Denmark) 20)                  ; "services": 20
       (=(economy-growth-price Denmark) 152)                       ; "economy growth: " : 152

                                                            ; -- Economy growth --
       (=(resources-growth Denmark) 89)               ; "resources": 89
       (=(industry-growth Denmark) 134)                ; "industry": 134
       (=(services-growth Denmark) 260)                ; "services": s260

                                                            ; -- Quality of life growth --
       (=(quality-index-resources-cost Denmark) 45)     ; "resources": 45
       (=(quality-index-industry-cost Denmark) 77)      ; "industry": 77
       (=(quality-index-services-cost Denmark) 132)      ; "services": 132

       ;predicates initialised                              ; -- Biases --
       (is-not-resources-biased Denmark)             ; resources: false
       (is-not-industry-biased Denmark)              ; industry: false
       (is-not-services-biased Denmark)              ; services: false

                                                            ; -- Technical --
       (is-not-growing-economy Denmark)                    ; "growing-eco": false
       (is-not-growing-quality-of-life Denmark)            ; "growing-quality-of-life": false
...
(:goal (and
        ...
        (>= (quality-of-life-index Czech-Republic) 190)
        (>= (quality-of-life-index Denmark) 190)
       )
    )
)
