...
; -- Variables --
(=(resources-sector Cyprus) 2)                  ; "resources": 2
(=(industry-sector Cyprus) 4)                   ; "industry": 4
(=(services-sector Cyprus) 29)                   ; "services": 29
(=(funds Cyprus) 35)                             ; "funds": 35
(=(quality-of-life-index Cyprus) 152)          ; "quality-of-life-index": 152

        ; -- Constants --
(=(resources-price Cyprus) 3)                 ; "resources": 3
(=(industry-price Cyprus) 3)                  ; "industry": 3
(=(services-price Cyprus) 3)                  ; "services": 3
