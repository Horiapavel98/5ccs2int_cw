...
; their initial state.
;
; Problem file 11 - includes 11 EU countries
(define (problem problem11)
        (:domain EU_economics)
        (:objects Belgium Germany France Italy Luxembourg Netherlands Austria Bulgaria Croatia Cyprus Czech-Republic  - Country)
