...
; their initial state.
;
; Problem file 9 - includes 9 EU countries
(define (problem problem9)
        (:domain EU_economics)
        (:objects Belgium Germany France Italy Luxembourg Netherlands Austria Bulgaria Croatia - Country)
